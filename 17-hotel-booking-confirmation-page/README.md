...
<img src="./src/assets/screenshots/mobile.png" width="50%" alt="mobile">

### Links

- Solution URL: [Solution](https://github.com/lyrachiang/frontend-mentor-challenges/tree/main/17-hotel-booking-confirmation-page)
- Live Site URL: [Solution Demo](https://lyrachiang.github.io/frontend-mentor-challenges/17-hotel-booking-confirmation-page/)
